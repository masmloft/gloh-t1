...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GLO_LED0_Pin|GLO_LED1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GLO_POLEV2_Pin|GLO_POLEV1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GLO_LED0_Pin GLO_LED1_Pin */
  GPIO_InitStruct.Pin = GLO_LED0_Pin|GLO_LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : GLO_POLEV2_Pin GLO_POLEV1_Pin */
  GPIO_InitStruct.Pin = GLO_POLEV2_Pin|GLO_POLEV1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
